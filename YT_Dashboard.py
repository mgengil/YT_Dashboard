...
def load_data():
    ...
    df_agg = pd.read_csv('Streamlit/datasets/Aggregated_Metrics_By_Video.csv').iloc[1:, :] # first row include total value of data
    ...
    df_agg_sub = pd.read_csv('Streamlit/datasets/Aggregated_Metrics_By_Country_And_Subscriber_Status.csv')
    df_comments = pd.read_csv('Streamlit/datasets/Aggregated_Metrics_By_Video.csv')
    df_time = pd.read_csv('Streamlit/datasets/Video_Performance_Over_Time.csv')
